...
def model(num_genes, allele_freq, sample_size, num_snps, beta_file, noise, num_factors, output):
...
def iter_model(config, seed, iterations, output):
    ...
    for i in range(iterations):
        ...
        model(num_genes, allele_freq, sample_size, num_snps, beta_location, noise_iter, num_factors, f'{folder}')
