...
def gamma_pipeline(input_folder, scripts_folder):
    ...
    for tar in targets:
        ...
        for beta in beta_values:
            ...
            gamma_cmd.append(f'python {scripts_folder}/gammaModel/calculate_gammaModel_mixture_iter.py -f {input_folder}/numTarget_{tar}/Beta_{value} -p {scripts_folder} -i 100'.split(' '))
            #gamma_cmd.append(f'python {scripts_folder}/gammaModel/calculate_gammaModel_mixture_iter.py -f {input_folder} -p {scripts_folder} -i 1000'.split(' '))
