...
DOWNLOAD_URL = 'http://github.com/cynthiaewu/trans-eQTL'
LICENSE = 'MIT'
...
with open(os.path.join(curdir, 'trexqtl/version.py'), 'w') as fout:
        fout.write(
            "\n".join(["",
...
setup(name=NAME,
      ...
      entry_points={
          'console_scripts': [
              'trexqtl-simulate=simulate.main:run',
              'trexqtl-run=trexqtl.main:run'
          ],
      },
      install_requires=[],
