...
def calculate_allpower(input_folder, scripts_folder):
    ...
    for tar in targets:
        ...
        for beta in beta_values:
            ...
            power_cmd.append(f'python {scripts_folder}/Simulator/calculate_power_matrixeqtl_onesuccess_nullsnps.py -c {input_folder}/numTarget_{tar}/Beta_{value}/metaconfig.yaml -f {input_folder}/numTarget_{tar}/Beta_{value} -i 100'.split(' '))
            # cpma power command
