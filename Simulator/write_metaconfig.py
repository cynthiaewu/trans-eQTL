...
def main():
    ...
    parser.add_argument("-c", "--identity", action='store_false', help="True if no gene correlation, False if gene correlation (covariance matrix will be the gene correlationn matrix of Nerve Tibial GTeX data")
